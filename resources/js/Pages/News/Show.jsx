...
function Show({ news }) {
    ...
    // Desain Badge disamakan dengan gaya AJP (Soft Background & Borderless)
            ...
            <div key={req.id} className={`p-4 rounded-xl border ${config.color} flex flex-col justify-between shadow-sm transition-all hover:shadow-md`}>
                <div>
                    <div className="flex items-center justify-between mb-3">
                        ...
                        {/* Status Badge Addon */}
                        {req.status === 'pending' && <span className="badge badge-sm badge-neutral border-none bg-base-200">Antre</span>}
                        {req.status === 'processing' && <span className="badge badge-sm badge-warning border-none bg-warning/20 text-warning-content">Diproses</span>}
                        {req.status === 'completed' && <span className="badge badge-sm badge-success border-none bg-success/20 text-success-content">Selesai</span>}
                        {req.status === 'rejected' && <span className="badge badge-sm badge-error border-none bg-error/20 text-error-content">Ditolak</span>}
                    </div>
                    ...
                    <div className="text-sm">
                        ...
                        {req.status === 'rejected' && (
                            <div className="mt-3 p-3 bg-red-50 text-red-800 rounded-lg text-xs flex gap-2 items-start border border-red-100">
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div className="text-sm breadcrumbs text-muted-foreground">
                                <ul>
                                    ...
                                    <li><Link href={route('news.index')}>Artikel Saya</Link></li>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                ...
                                <div className="space-y-3 pt-2">
                                    <div className="aspect-[16/9] w-full rounded-2xl overflow-hidden shadow-sm border border-base-200 bg-muted group">
                                        <img
                                ...
                                {/* Isi Artikel */}
                                <Card className="p-6 md:p-8 shadow-sm border-base-200">
                            ...
                            <div className="lg:col-span-1 space-y-6">
                                ...
                                {news.url && (
                                    <Card className="border-primary/20 bg-primary/5 shadow-sm">
                                        ...
                                        <div className="mt-3">
                                            <a href={news.url} target="_blank" rel="noreferrer" className="btn btn-sm btn-primary w-full shadow-sm">
                                ...
                                <Card className="shadow-sm border-base-200">
                                    ...
                                    <div className="flex flex-col gap-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-xs text-muted-foreground font-medium mb-0.5">Nama Lengkap</p>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-xs text-muted-foreground font-medium mb-0.5">Profesi / Jabatan</p>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-xs text-muted-foreground font-medium mb-0.5">Kota / Lokasi</p>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-xs text-muted-foreground font-medium mb-0.5">Kontak (WhatsApp)</p>
